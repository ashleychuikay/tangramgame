...
Prior work has shown that many children struggle to form referential pacts with age-matched peers, but can do so with explicit feedback from experimenters [@deutsch1982]. Our study shows that even young children can successfully form referential pacts with their parents: Accuracy increases, fewer turns are taken, and utterances become shorter. These results suggest that parents may naturally scaffold their children's referential pact formation.
