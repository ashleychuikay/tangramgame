...
```{r origins, cache=T, fig.env = "figure", fig.pos = "t", fig.width=3, fig.height=2, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "\\label{fig:origins}Probability of words used on final round first occuring with child or parent. Error bars are 95\\% CI."}
