...
.\todo[inline]{Describe data pre-processing pipeline here.}

## Results

### Performance accuracy

```{r accuracy, cache=T, fig.env = "figure", fig.pos = "h", fig.width=4, fig.height=2, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "Accuracy improves over time. Error bars are 95\\% CIs. \\todo[inline]{TODO: We should combine this into single 2-col figure with num exchanges.}"}
