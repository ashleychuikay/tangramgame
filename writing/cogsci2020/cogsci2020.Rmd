...
Twelve solid black images of tangrams were normed on Amazon Mechanical Turk (n = 60) for pairwise similarity. Each participant made 22 pairwise similarity judgments on a scale from 1-100. Based on these similarity ratings ($M$ = 42.3, $SD$ = 26.1), the ten maximally dissimilar tangrams were selected for use as stimuli (Fig. \ref{fig:ipads}A).
