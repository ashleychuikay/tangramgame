...
While children often struggle to succeed in such games with their peers, we found that even young children are able to successfully form referential pacts with their parents: Accuracy increases, fewer turns are taken, and utterances gradually become shorter over the course of interaction. 
