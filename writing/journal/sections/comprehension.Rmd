...
Descriptions given from the later appearance of each item do not appear to contain less information for guessing the target.

### Response times are faster for parent descriptions
