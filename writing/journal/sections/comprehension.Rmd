...
bind_rows(tidy_turk_data, tidy_kid_data) %>%
  ...
  mutate(comprehender_group = ifelse(comprehender_group == 'kid', 'child', 'parent'),
         comprehender_group = paste0('naive ', comprehender_group, ' as comprehender'),
         director = paste(' produced by\n', director)) %>%
