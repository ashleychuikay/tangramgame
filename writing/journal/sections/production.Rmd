...
indiv.measures.lmer <- indiv.measures %>%
  ...
  glmer(far_close_overlap ~ age_group * target_type + utt_length + (1 | target) +
        (1 + target_type | id),
        family = 'binomial',
        data = .) %>%
  tidy() %>%
