...
Similar results were obtained using 'softer' measures like edit distance, which is the number of edits required to turn one string into the other, $b= `r soft.inter$estimate`, z = `r soft.inter$statistic`, p = `r soft.inter$p.value`$ (see Supplemental Fig. \ref{fig:Levensthein_appendix}). 
