...
To control for the fact that longer utterances strings are less likely to exactly match by chance, we also include a term for the average length of the close and far labels for that speaker and item. 
...
Similar results were obtained using 'softer' measures like edit distance, the number of edits required to turn one string into the other, $b=`r soft.inter$estimate`, z = `r soft.inter$statistic`, p = `r soft.inter$p.value`$ (see Fig.~\ref{fig:Levensthein_appendix}). 
