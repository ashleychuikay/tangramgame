...
In Experiment 2, we found that even young children produced sufficiently informative descriptions of novel tangrams. 
...
# this block pre-processes the raw, un-anonymized data
