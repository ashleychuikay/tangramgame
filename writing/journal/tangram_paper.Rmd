...
Our first experiment found that young children are able to successfully coordinate on pacts with their parents.
...
One possibility is that the difficulty lies primarily in the process of *comprehension*; children might be poor listeners.
If each child has their own idiosyncratic way of conceptualizing a tangram, they may be unable to understand or accommodate their partner's description if it does not align with their own way of thinking about it.
...
In Experiment 2, we conducted a comprehension experiment to test the first of these two hypotheses. 
...
If children are bad listeners, we might expect that naive adults would be equally good at understanding referring expressions produced by children and adults, while naive children would be equally bad.
Conversely, if naive children are able to understand the referring expressions produced by parents, then we may expect the source of the difficulty to be elsewhere.

# Methods

### Participants

XXX adults (ages XXX) were recruited from MTurk.
...
Data from XXXX pairs were dropped due to failure to complete the study, leaving a final sample of XXX pairs. 
