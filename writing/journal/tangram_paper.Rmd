...
abstract: |
   Adults readily coordinate on *ad hoc* conventions, or temporary pacts about how to refer to things, over the course of conversation. 
   Young children notoriously struggle to spontaneously form such pacts with peers.
   Importantly, however, recent studies have revealed improved capacities in response to targeted experimenter interventions. 
   Here, we investigate whether parents may *spontaneously* provide a similar kind of scaffolding.
   In Experiment 1, we show that children (ages 4, 6, 8) are able to coordinate on increasingly accurate and efficient pacts with their parents in a director-matcher task. 
   Parents spontaneously initiate more clarification exchanges with younger children who, in turn, are more likely to adopt labels introduced by the parent. 
   ...
   Contrary to classical views attributing childrens' coordination failures to lexical rigidity or failures of perspective-taking, our findings support the idea that children readily form pacts when scaffolding from their partner can help overcome production difficulties.
...
While adults readily form conversational pacts with one another, studies examining peer interactions between children have yielded more mixed results. 
...
These classic results are perhaps surprising from a contemporary perspective, given that children engage in relatively fluent conversation at this age and are able to track at least some aspects of common ground [@vasil2023new], including visual perspective [@nadig2002evidence; @nilsen2009relations; @khu2020preschoolers] and referential precedence [@matthews2010; @ostashchenko2019referential; @yoon2021s; @akhtar1996role; @graham2014]. 
Indeed, more recent studies revisiting the peer-interaction paradigm have found that pairs of children as young as 4 years old *are* in some cases able to get informative pacts off the ground with one another [@koymen2014; @branigan2016].

What accounts for the mixed pattern of results in this literature? 
One key factor may be the presence or absence of targeted feedback from adult experimenters. 
For example, @koymen2014 explicitly prompted 4- to 6-year-old participants to ask clarification questions when their partner was underinformative, and @branigan2016 provided explicit feedback on accuracy after each round of trials in a study with 8- to 10-year-old children [see also @matthews2007].^[A similar effect of feedback was noted as far back as @krauss1977 ("Children in the first, third, and fifth grades did improve, with the help of comments from the experimenter pointing out the mistakes they had been making.")]
Developmental changes were also observed in both of these studies, indicating that the underlying mechanisms may be graded and continue to develop into middle childhood. 
For example, @koymen2014 found that 6-year-olds were more likely to use a referential pact with an old partner than 4-year-olds, who only reliably did so when the pacts were proper nouns. 
Thus, it is possible that targeted experimenter feedback may be required for children to successfully construct conversational pacts with peers, and the ability to proactively initiate the requisite speech acts does not develop until later.
 
Of course, in everyday conversation, children do not have access to explicit guidance from researchers.
In our study, we ask whether parents may nonetheless play a similar role in scaffolding referental pacts with their children. 
After all, children interact frequently with their parents, who are not only more linguistically capable than their peers, but also have fine-grained representations about their children's knowledge [@leung2021]. 
We consider three possible ways that peer communication among children may go awry in the absence of experimenter feedback, corresponding to three basic problems a referential utterance must solve.

First, there is the *absolute* problem of lexical fitness: the utterance must be recognized as a good enough literal description of the target object for the listener to identify it as applicable. 
...
**Utterance-level comprehension:** In order to identify the target of a referential utterance, children must determine whether the information contained in it is a good description of each potential referent. Without scaffolding, children may struggle to identify the relevant and informative components of a complex utterance, even if it is sufficiently informative. For example, given a referring expression like "the shoe with the brown laces," they may only attend to a sub-expression like "shoe" [@speer1984two]. 
...
Our investigation begins with the observation that parents may be spontaneously doing something to support the formation of conversational pacts when talking with their children that children are not able to do with one another. 
...
A long literature of developmental work dating back to Krauss and Glucksberg [-@krauss1977] has revealed surprising failures to interactively form pacts even among older children who are sensitive to partner-specific perspective and referential precedent [@nadig2002evidence; @nilsen2009relations; @khu2020preschoolers; @matthews2010; @ostashchenko2019referential; @yoon2021s; @akhtar1996role; @graham2014]. 
Here, we turned to parent-child interactions for insight, asking whether parents may spontaneously be adopting some of the strategies used by experimenters to elicit pacts in recent studies [@koymen2014; @branigan2016]. 
We found that whatever obstacles arise in peer communication are, to some extent, resolved through parental scaffolding: parents of younger children engaged in more conversational turns, asked more clarification questions, produced longer referential expressions, and adopted less complex labels. 
...
Our studies contribute to the debate over *why* children may struggle to form referential pacts in some cases and not in others. 
