...
# Experiment 2: Comprehension experiment

Given appropriate scaffolding from their parents, we have found that even young children are able to successfully coordinate on pacts.
But why do younger children struggle so much in the first place?
Understanding the source of their difficulty may shed new light on what allows children to succeed in interactions with their parents while failing in interactions with their peers.
One possibility is that the difficulty lies primarily in the process of *comprehension*.
Each child may have their own idiosyncratic way of conceptualizing and describing tangrams, and are simply unable to understand or accommodate their partner's descriptions.
Another possibility is that the difficulty lies in *production*.
In other words, children may have difficulty generating a sufficiently descriptive referring expression on their own, given their limited vocabulary.

In this study, we explored the ability of children and adults to comprehend the descriptions provided by both children and adults.
If the primary source of difficulty were comprehension, we might expect that naive adults would equally good at understanding referring expressions produced by children and adults, while naive children would be equally bad.
