...
An alternative possibility for children's failure to form conversational pacts is that children face comprehension difficulties. Prior work shows that young children struggle to judge which referential expressions are more informative, even when making judgments about their own expressions [@asher1976, @robinson1977]. Therefore, children may not be able to successfully identify relevant and uniquely identifying information from a referential expression. Children's comprehension problems may be further compounded by their production difficulties--in age-matched pairs where the director produces underinformative expressions and where the matcher fails to seek clarification, children do not form the necessary common ground to communicate successfully with one another.

While numerous studies have found that children struggle to negotiate and construct conversational pacts with peers, young children can and do participate in conversation. What might support children's communicative abilities from a young age? One important factor is that children do not only interact with peers. From a young age, children constantly engage with adults, often their caregivers, in communicative and referential settings. Adults may provide children with a model of informative referential expressions, and can also seek clarification when children's utterances are unclear. 
