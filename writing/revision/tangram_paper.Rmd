...
Why do pairs of children apparently succeed in some studies and fail in others?
...
Meanwhile, while @branigan2016 found that while 8- to 10-year-old participants were able to coordinate on pacts given explicit feedback about their accuracy, their error rates were much higher in absolute terms than adults.
...
Our investigation thus begins by asking whether parents may be spontaneously doing something to support the formation of conversational pacts when talking with their children that children are not able to do with one another. 
...
As a rough estimate of the content of parents' responses when their child was the director, we counted the number of question marks in the transcript.
...
It is possible that these proportions reflect an artifact of the transcriptions, but the same RAs transcribed sessions across multiple age groups, applying a consistent strategy, and the population of parents should be roughly comparable across children's age groups.
