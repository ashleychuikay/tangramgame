...
lmer.exchanges %>%
  ...
  kable(
    format = "latex",
    booktabs = TRUE,
    caption = "\\label{tab:exchanges} Output of full Exp. 1 exchanges model: \\texttt{exchanges $\\sim$ comprehender\\_group + age + person + occurrence + (1 + comprehender\\_group + person | gameid)}"
  )
```
