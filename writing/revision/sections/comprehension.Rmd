...
Yet these findings alone do not resolve the puzzle of how, exactly, such scaffolding helps. 
What are the underlying reasons for children's difficulties, such that parental scaffolding is able to help overcome them?
...
The stimuli sets were designed such that all participants encountered 5 utterances originally generated by a parent and 5 by a child, and 5 utterances from the first round and 5 from the final round. 
...
Although children may not necessarily be worse at comprehending utterances, our data did reveal that referential expressions originally *generated* by younger children were less accurately comprehended by naive adults and children alike (see Appendix C). 
...
This discourse-level mechanism is also consistent with the qualitative observation that parents are more likely to ask questions with 4-year-olds than with older age groups (see Appendix A). 
