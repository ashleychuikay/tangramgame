...
We recruited `r passed_check$false + passed_check$true` adults from Amazon Mechanical Turk. Participants were compensated 60¢ for a short task. Data from `r passed_check$false` participants were dropped due to failure to pass an attention check, leaving a final sample of `r passed_check$true` adults. 
