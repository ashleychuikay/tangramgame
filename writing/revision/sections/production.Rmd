...
Variability across contexts could be driven less by pragmatic reasoning and more by sampling under uncertainty: they may be producing utterances as samples from a more spread-out lexical distribution [@denison2013rational; @bonawitz2014probabilistic].
