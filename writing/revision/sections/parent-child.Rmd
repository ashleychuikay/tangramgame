...
Pairs of participants were brought into the lab to play a cooperative director-matcher game. They were seated in front of iPads at opposite ends of a table, with a divider preventing them from seeing the other's screen. Participants were told that they would take turns playing *director* and *matcher* roles. On each trial, a context of two tangrams were shown on their screens. One of these tangrams was the target, and the other was the foil. The director's task was to describe the *target* image, privately indicated by a blue border, and the matcher's task was to select one of the two images on their screen based on the director's description (Figure \ref{fig:ipads}B). Before beginning the experiment, participants played six practice trials with images of common fruits and vegetables. 
