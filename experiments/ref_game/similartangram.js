...
var xhr = new XMLHttpRequest(),
    method = "GET",
    url = "https://cdn.jsdelivr.net/gh/ashleychuikay/tangramgame@master/gamecode/similartrials.csv"
...
var tangrams = ["B2", "I1", "J1", "K1", "L1", "N1", "O1", "R1", "T1", "U1"];
...
var experiment = {
	...
	processOneRow: function () {
		...
		$.post("https://callab.uchicago.edu/experiments/tangramgame/gamecode/similartangramsave.php", {postresult_string : dataforRound});	
	},
    ...
    directorStudy: function(counter){
		...
		var directorobjects_html = "";
	   	...
	   	//HTML for the first object on the left
		leftname = "similarimages/" + directorImages[0] + ".jpg";
		...
		//HTML for the first object on the right
		rightname = "similarimages/" + directorImages[1] + ".jpg";
  	...
  	matcherStudy: function(counter) {
		...
		var matcherobjects_html = "";
	   	...
	   	//HTML for the first object on the left
		leftname = "similarimages/" + matcherImages[0] + ".jpg";
		...
		//HTML for the first object on the right
		rightname = "similarimages/" + matcherImages[1] + ".jpg";
		...
		$('.pic').on('click touchstart', function(event) {
	    	...
	    	switch(picID) {
	    		case "leftPic4":
	    			...
	    			$("#leftPic4").attr("src", "similarimages/"+ matcherImages[0] +"_color.jpg")
	    			$("#rightPic4").attr("src", "similarimages/"+ matcherImages[1] +".jpg")
	    			break;
	    		...
	    		default: // "rightPic4"
	    			...
	    			$("#rightPic4").attr("src", "similarimages/"+ matcherImages[1] +"_color.jpg")
	    			$("#leftPic4").attr("src", "similarimages/"+ matcherImages[0] +".jpg")
	    	};
